...
def load_isnet_model():
    ...
    if os.path.exists('isnet.pth'):
        ...
        # [NUCLEAR FIX]: साइज अनुसार २१५८ लेयर जोड्ने
...
def process_image(img_bgr):
    ...
    with torch.no_grad():
        ...
        # isnet.py ले पहिले नै sigmoid(d1) लिस्टमा दिन्छ
        result = preds[0][0] 
            
    mask = result.squeeze().cpu().numpy()
    mask = np.nan_to_num(mask, nan=0.0) # NaN फिक्स
    
    # म्यास्कलाई चट्ट गाढा बनाउने (Normalization)
